const CACHE_NAME = 'calidad-proceso-v2026-fix-35';
...
const ASSETS_LOCALES = [
  './',
  'index.html',
  // Con la version en la URL: index.html pide 'app.js?v=35', y cache.match compara
...
self.addEventListener('fetch', (e) => {
  ...
  e.respondWith((async () => {
    ...
    try {
      ...
      // Segundo intento ignorando la ?v=: cubre el caso de un telefono que
      // todavia tiene guardada la version anterior del archivo. Mejor servir algo
      // viejo que dejar la app en blanco en medio de la planta.
